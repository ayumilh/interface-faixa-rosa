...
import ModalBuscaconvenio from "@/components/search/modalbuscaconvenio"; // Importa o Modal de Busca
import EstablishmentCard from "@/components/convenio/EstablishmentCard"; // Importa o novo componente
import { estabelecimentos } from "@/components/convenio/estabelecimentosData"; // Importa os dados
...
export default function Convenio() {
  ...
  // Função para lidar com a seleção de uma cidade no ModalBusca
  const handleSelectCity = (cityName, stateSigla) => {
    setSelectedCity(cityName);
    setSelectedState(stateSigla);
  };

  // Filtrando estabelecimentos usando useMemo para otimização
    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex-grow mt-24">
        ...
        >
          ...
          {/* Conteúdo da Seção de Cabeçalho */}
        ...
        <section className="bg-white py-6 sm:py-8 shadow-md">
          <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row justify-between items-center">
            ...
            <div className="w-full sm:w-1/2 mb-4 sm:mb-0">
              <label className="block text-gray-700 font-semibold mb-2" htmlFor="cidade">
                Cidade Selecionada:
              </label>
            ...
            <div className="w-full sm:w-1/2">
              <label className="block text-gray-700 font-semibold mb-2" htmlFor="categoria">
                Categoria:
              </label>
