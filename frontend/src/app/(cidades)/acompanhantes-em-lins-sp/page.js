// src/app/cidades/acompanhantes-em-lins-sp/page.js
// Este é o componente da página principal para Acompanhantes em Lins, SP.
 ...
 */
export default function AcompanhantesLins() {
  const city = "Lins";
  const stateUF = "SP";
