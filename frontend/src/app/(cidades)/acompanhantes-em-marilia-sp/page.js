// src/app/cidades/acompanhantes-em-Marilia-sp/page.js
// Este é o componente da página principal para Acompanhantes em Marilia, SP.
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-6">
          <div className="text-center sm:text-left w-full sm:w-auto">
            <h2 className="text-lg sm:text-xl font-bold text-gray-800 mb-1 flex items-center justify-center sm:justify-start gap-2">
              ...
              {count} perfis encontrados em Marilia
            </h2>
    ...
    return (
      ...
      >
        ...
        <p className="text-gray-500 mb-6 sm:mb-8 px-6 text-base sm:text-lg">
          Não encontramos perfis em Marilia com os filtros selecionados.
...
/**
 * Componente da página principal para Acompanhantes em Marilia, SP.
 * Ele integra todos os subcomponentes para formar o layout completo da página com UI/UX refinado.
 * @returns {JSX.Element} A página AcompanhantesMarilia.
 */
export default function AcompanhantesMarilia() {
  const city = "Marilia";
  const stateUF = "SP";
      ...
      <main className="flex-1 pt-20 sm:pt-28 pb-10 sm:pb-16 z-10">
        ...
        >
          ...
          <p className="text-gray-700 mt-3 sm:mt-4 text-lg sm:text-xl max-w-3xl mx-auto font-light">
            Conecte-se com perfis verificados e desfrute de experiências únicas, seguras e inesquecíveis na vibrante cidade de Marilia.
          </p>
        ...
        >
          <Stories cidade={`Marilia`} estado={`SP`} />
        </motion.div>
