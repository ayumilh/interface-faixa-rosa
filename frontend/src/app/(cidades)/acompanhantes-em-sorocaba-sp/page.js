// src/app/cidades/acompanhantes-em-Sorocaba-sp/page.js
// Este é o componente da página principal para Acompanhantes em Sorocaba, SP.
// Ele usa "use client" para elementos interativos como filtros e animações.
"use client"; // IMPORTANTE: Isso o torna um Client Component
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-6">
          <div className="text-center sm:text-left w-full sm:w-auto">
            <h2 className="text-lg sm:text-xl font-bold text-gray-800 mb-1 flex items-center justify-center sm:justify-start gap-2">
              ...
              {count} perfis encontrados em Sorocaba
            </h2>
    ...
    return (
      ...
      >
        ...
        <p className="text-gray-500 mb-6 sm:mb-8 px-6 text-base sm:text-lg">
          Não encontramos perfis em Sorocaba com os filtros selecionados.
...
/**
 * Componente da página principal para Acompanhantes em Sorocaba, SP.
 * Ele integra todos os subcomponentes para formar o layout completo da página com UI/UX refinado.
 * @returns {JSX.Element} A página AcompanhantesSorocaba.
 */
export default function AcompanhantesSorocaba() {
  const city = "Sorocaba";
  const stateUF = "SP";
      ...
      <main className="flex-1 pt-20 sm:pt-28 pb-10 sm:pb-16 z-10">
        ...
        >
          ...
          <p className="text-gray-700 mt-3 sm:mt-4 text-lg sm:text-xl max-w-3xl mx-auto font-light">
            Conecte-se com perfis verificados e desfrute de experiências únicas, seguras e inesquecíveis na vibrante cidade de Sorocaba.
          </p>
        ...
        >
          <Stories cidade={`Sorocaba`} estado={`SP`} />
        </motion.div>
        ...
        {/* Seção de Conteúdo SEO - RENDERIZADO COMO UM SERVER COMPONENT PARA SEO */}
        {/* O limite Suspense está correto aqui para um Server Component */}
        <Suspense fallback={
          <div className="max-w-7xl mx-auto px-4 sm:px-6 mt-12 mb-12 text-center text-gray-500">
            <Sparkle size={32} className="mx-auto animate-pulse text-pink-300" />
            <p className="mt-2">Carregando informações importantes...</p>
          </div>
        }>
            {/* SEOContent é um Server Component, então é renderizado diretamente */}
            <SEOContent />
        </Suspense>
