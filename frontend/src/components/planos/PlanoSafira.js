...
const BenefitItem = memo(({ text, hasBenefit = true }) => (
  <li className="flex items-start space-x-2 sm:space-x-3">
    {hasBenefit ? (
      ...
      <>
        <FaTimesCircle className="text-blue-500 flex-shrink-0 w-4 h-4 sm:w-5 sm:h-5" />
        <span className="text-black">Sem convênio</span>
      </>
    )}
  </li>
));
        ...
        >
          ...
          <div className="relative w-full h-64 mb-4 overflow-hidden rounded-lg">
            {images.length > 0 ? (
              ...
              <div
                className={`w-full h-56 rounded-md flex items-center justify-center text-gray-500 ${
          ...
          <div className="flex flex-col items-center mb-4">
            <div
              className={`relative w-24 h-24 rounded-full border-4 border-transparent bg-gradient-to-r from-blue-600 via-blue-500 to-blue-600 hover:from-blue-700 hover:via-blue-600 hover:to-blue-700 shadow-lg overflow-hidden transition-all duration-300 ease-in-out transform hover:scale-105`}
            >
              <Image
...
const CardSafiraLight = memo(
  ({
    ...
    return (
      <>
        <div
          className={`border border-blue-500 rounded-xl shadow-lg p-6 relative transition transform hover:scale-105 hover:shadow-xl ${
            theme === "dark" ? "bg-gray-800 text-white" : "bg-white text-gray-800"
          }`}
        >
          ...
          <div className="grid grid-cols-2 gap-4 text-sm mb-4">
            <div>
              ...
              <div className="flex items-center mt-2">
                <FaCamera className="text-blue-500 mr-1" />
          ...
          {contact && (
            <button
              className="mt-4 bg-gradient-to-r from-blue-500 to-blue-500 hover:from-blue-600 hover:to-blue-600 text-white py-2 px-6 rounded-full flex items-center justify-center font-semibold transition-all shadow-md hover:shadow-lg text-lg"
...
const CardDark = memo(
  ({
    ...
    return (
      <>
        <div className="bg-black border border-blue-500 rounded-xl shadow-lg p-6 relative transition transform hover:scale-105 hover:shadow-xl">
          {/* Carrossel de Imagens */}
...
const PlanoSafira = () => {
  ...
  return (
    <div className="max-w-md w-full mx-auto rounded-3xl shadow-xl overflow-hidden">
      <div className="p-6 sm:p-8 flex flex-col h-full bg-white">
        <div>
          {/* Título do Plano */}
          <div className="flex items-center space-x-2 sm:space-x-3 mb-4 sm:mb-6">
            <GiDiamondHard className="text-blue-500 text-2xl sm:text-3xl" />
...
<span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-500">
          ...
          {/* Pontos de Listagem */}
          <p className="bg-white text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-500 font-semibold text-xs sm:text-sm px-3 py-1 rounded-full inline-block mb-6 sm:mb-8">
          +1.000 pontos de listagem
          </p>
          {/* Benefícios */}
      ...
      <div className="flex-grow flex flex-col justify-end -mt-6">
          ...
          <div className="text-center mb-8">
            ...
            {/* Preço do plano */}
            <p className="text-3xl font-bold text-gray-800">R$ 287,90</p>
      ...
      {isModalOpen && (
        <Modal
          ...
          description="Descubra como o plano Safira realça seu anúncio e maximiza a visibilidade. Para aproveitar o modo escuro (Dark Mode), certifique-se de que o recurso está habilitado no seu plano."
          theme={modalTheme}
        >
          ...
          {/* Exibir CardSafiraLight ou CardDark com tema selecionado */}
          {modalTheme === "light" ? (
            <CardSafiraLight
              name="Nome do Anunciante"
              price={250}
