  ...
  const articles = [
    {
      ...
      description: "No universo da plataformo Faixa Rosa, a diversidade é celebrada e a inclusão é um...",
    ...
    },
    {
      ...
      description: "No cenário digital em constante evolução, a segurança online tornou-se uma prioridade inegável. Para os...",
  ...
  return (
    <div className="flex flex-col items-center py-12 bg-gray-50">
      ...
      <div className="w-full max-w-xs md:hidden px-4">
        ...
        {/* Controles para navegar entre artigos */}
